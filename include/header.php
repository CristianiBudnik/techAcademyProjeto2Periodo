...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Barlow:wght@400;600;700;900&display=swap"
        rel="stylesheet">
    ...
    <header class="fixed-top">
        <nav class="navbar navbar-expand-lg" data-bs-theme="light">
            ...
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-fluid" src="img/logoextensa.png" alt="BDK Esquadrias"
                        width="120px"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=inicio">Início</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=sobre">Sobre</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page=catalago">Catálogo</a>
                        </li>
                        <li class="nav-item">
